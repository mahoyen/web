...
urlpatterns = [
    ...
    path('create/', login_required(reservation.reservation.ReservationCreateView.as_view()), name="create_reservation"),
    path('create/<int:machine>/', login_required(reservation.reservation.ReservationCreateView.as_view()), name="create_reservation"),
    path('edit/<int:pk>/', login_required(reservation.reservation.ReservationEditView.as_view()), name="edit_reservation"),
